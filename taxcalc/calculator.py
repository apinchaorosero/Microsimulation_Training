...
import pandas as pd
<<<<<<< HEAD
from taxcalc.functions import (net_salary_income, calc_income_house_property, gross_total_income,
=======
from taxcalc.functions import (net_salary_income, calc_income_house_property,
                               calc_tax_LTCG, gross_total_income,
>>>>>>> upstream/master
...
<<<<<<< HEAD
=======
        calc_tax_LTCG(self.__policy, self.__records)        
>>>>>>> upstream/master
